...
class ImageCommentsSnapshotTests: XCTestCase {
	...
	private func comments() -> [ImageCommentViewModel] {
		return [
			...
			ImageCommentViewModel(message: "The East Side Gallery is an open-air gallery in Berlin. It consists of a series of murals painted directly on a 1,316 m long.", username: " Long Long username", date: "4 minutes ago"),
			ImageCommentViewModel(message: "The East Side Gallery.", username: "username", date: "1 day ago")
		]
	}
}

private extension ListViewController {
	func display(_ stubs: [ImageCommentViewModel]) {
		let cells: [CellController] = stubs.map { viewModel in
			CellController(id: UUID(), ImageCommentCellController(viewModel: viewModel))
		}
